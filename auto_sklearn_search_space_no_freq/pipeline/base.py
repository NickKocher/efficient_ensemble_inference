...
from auto_sklearn_search_space_no_freq.pipeline.components.regression.extra_trees import ExtraTreesRegressor
from auto_sklearn_search_space_no_freq.pipeline.components.classification.extra_trees import ExtraTreesClassifier
from auto_sklearn_search_space_no_freq.pipeline.components.regression.random_forest import RandomForest as RandomForestRegressor
from auto_sklearn_search_space_no_freq.pipeline.components.classification.random_forest import RandomForest as RandomForestClassifier
from auto_sklearn_search_space_no_freq.pipeline.components.regression.k_nearest_neighbors import KNearestNeighborsRegressor
from auto_sklearn_search_space_no_freq.pipeline.components.classification.k_nearest_neighbors import KNearestNeighborsClassifier
from auto_sklearn_search_space_no_freq.pipeline.components.feature_preprocessing.random_trees_embedding import RandomTreesEmbedding
from auto_sklearn_search_space_no_freq.pipeline.components.feature_preprocessing.extra_trees_preproc_for_classification import ExtraTreesPreprocessorClassification
from auto_sklearn_search_space_no_freq.pipeline.components.feature_preprocessing.extra_trees_preproc_for_regression import ExtraTreesPreprocessorRegression
