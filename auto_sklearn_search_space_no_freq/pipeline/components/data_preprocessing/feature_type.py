...
from auto_sklearn_search_space_no_freq.data.validation import SUPPORTED_FEAT_TYPES, SUPPORTED_TARGET_TYPES
from auto_sklearn_search_space_no_freq.pipeline.base import (
    DATASET_PROPERTIES_TYPE,
    PIPELINE_DATA_DTYPE,
    BasePipeline,
)
from auto_sklearn_search_space_no_freq.pipeline.components.base import (
    AutoSklearnChoice,
    AutoSklearnComponent,
    AutoSklearnPreprocessingAlgorithm,
)
from auto_sklearn_search_space_no_freq.pipeline.components.data_preprocessing.feature_type_categorical import (  # noqa : E501
    CategoricalPreprocessingPipeline,
)
from auto_sklearn_search_space_no_freq.pipeline.components.data_preprocessing.feature_type_numerical import (
    NumericalPreprocessingPipeline,
)
from auto_sklearn_search_space_no_freq.pipeline.components.data_preprocessing.feature_type_text import (
...
class FeatTypeSplit(AutoSklearnPreprocessingAlgorithm):
    ...
    def __init__(
        ...
        # WIP dirty workaround to allow running of foreign configs, i.e from search_space.pipelines that need feature transformers this dataset doesnt
