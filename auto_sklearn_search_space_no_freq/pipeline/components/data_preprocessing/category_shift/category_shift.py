...
import auto_sklearn_search_space.pipeline.implementations.CategoryShift
...
class CategoryShift(AutoSklearnPreprocessingAlgorithm):
    ...
    def fit(
        ...
        self.preprocessor = auto_sklearn_search_space.pipeline.implementations.CategoryShift.CategoryShift()
