...
class AdaboostRegressor(AutoSklearnRegressionAlgorithm):
    def __init__(self, n_estimators, learning_rate, loss, max_depth, frequency, random_state=None):
    ...
    def get_hyperparameter_search_space(
        ...
        cs.add_hyperparameters([n_estimators, learning_rate, loss, max_depth, frequency])
        return cs
