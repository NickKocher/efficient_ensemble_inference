...
class Nystroem(AutoSklearnPreprocessingAlgorithm):
    def __init__(
        self, kernel, n_components, frequency, gamma=1.0, degree=3, coef0=1, random_state=None
    ):
        self.kernel = kernel
    ...
    def get_hyperparameter_search_space(
        ...
        cs.add_hyperparameters([kernel, degree, gamma, coef0, n_components, frequency])
