...
from auto_sklearn_search_space.pipeline.constants import DENSE, SPARSE, UNSIGNED_DATA
...
class KernelPCA(AutoSklearnPreprocessingAlgorithm):
    def __init__(
        self, n_components, kernel, frequency, degree=3, gamma=0.25, coef0=0.0, random_state=None
    ):
    ...
    def get_hyperparameter_search_space(
        ...
        cs.add_hyperparameters([n_components, kernel, degree, gamma, coef0, frequency])
