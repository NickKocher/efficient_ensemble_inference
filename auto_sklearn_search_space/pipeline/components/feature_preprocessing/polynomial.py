...
class PolynomialFeatures(AutoSklearnPreprocessingAlgorithm):
    def __init__(self, degree, interaction_only, include_bias, frequency, random_state=None):
        self.degree = degree
    ...
    def get_hyperparameter_search_space(
        ...
        cs.add_hyperparameters([degree, interaction_only, include_bias, frequency])
