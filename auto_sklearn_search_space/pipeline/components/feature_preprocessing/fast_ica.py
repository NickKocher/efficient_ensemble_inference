...
class FastICA(AutoSklearnPreprocessingAlgorithm):
    def __init__(self, algorithm, whiten, fun, frequency, n_components=None, random_state=None):
    ...
    def get_hyperparameter_search_space(
        ...
        cs.add_hyperparameters([n_components, algorithm, whiten, fun, frequency])
