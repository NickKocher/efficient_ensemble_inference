...
from auto_sklearn_search_space.pipeline.base import DATASET_PROPERTIES_TYPE
from auto_sklearn_search_space.pipeline.components.base import AutoSklearnPreprocessingAlgorithm
from auto_sklearn_search_space.pipeline.components.data_preprocessing.rescaling.abstract_rescaling import (  # noqa: E501
    Rescaling,
)
from auto_sklearn_search_space.pipeline.constants import (
    DENSE,
    INPUT,
    SIGNED_DATA,
    SPARSE,
...
class QuantileTransformerComponent(Rescaling, AutoSklearnPreprocessingAlgorithm):
    ...
    def get_hyperparameter_search_space(
        ...
        cs.add_hyperparameters((n_quantiles, output_distribution, frequency))
        return cs
